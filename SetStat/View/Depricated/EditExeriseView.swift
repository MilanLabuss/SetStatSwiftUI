...
//                    sets = [MySet(id: UUID(), weight: 0, reps: 0,isCompleted: false, date: Date.now ,exercise: exercise), MySet(id: UUID(), weight: 0, reps: 0, isCompleted: false,date: Date.now , exercise: exercise)]
//                }
//                sortSets()
//                
//            }
